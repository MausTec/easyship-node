 ...
 *  the instance's path (e.g. "addresses" or "shipments"). absolute paths, relative
 *  to BASE_PATH, can be specified starting with '/', which will overwrite any Path
 *  specified in the parent Resource.
 * @param [spec.required=[]] Array of required arguments in the order that they
 *  must be passed by the consumer of the API. Subsequent optional arguments are
 *  optionally passed through a hash (Object) as the penultimate argument
 *  (preceding the also-optional callback argument, which always comes last)
 */
